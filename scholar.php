...
$scholarship = $conn->query("SELECT * FROM scholarship ORDER BY scholarshipId");
$scholarship->execute();
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
      <div class="container-fluid">
        <ul class="navbar-nav mb-2 mb-lg-0">
          ...
          <li class="nav-item fw-normal">
            <a class="nav-link" aria-current="page" href="scholarshipPage.php">จัดการทุนการศึกษา</a>
          </li>
        </ul>
        <ul class="navbar-nav mb-2 mb-lg-0">
          <form class="d-flex">
    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        if (isset($_GET['scholarshipId'])) {
          ...
          $sql = $conn->query("SELECT students.*,scholarship.schType 
                                  FROM students 
                                  INNER JOIN scholarship ON students.scholarshipId=scholarship.scholarshipId
                                  WHERE students.scholarshipId=$scholarshipId
