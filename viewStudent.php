                ...
                <div class="panel">
                    <?php foreach ($data as $rows) { ?>
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="actResult.php"> <i class="fa fa-calendar"></i> Recent Activity &nbsp;<span class="label  pull-right r-calendar">&nbsp;</span></a></li>
                            <li><a href="#"> <i class="fa fa-download"></i>Download to PDF</a></li>
                            <li><a href="editStudentPage.php?stId=<?php echo $_SESSION['user_login'] ?>"><i class="fa fa-edit"></i>Edit Personal Information</a></li>
                            <li><a href="user.php"> <i class="fa fa-home"></i> Go Back </a></li>
                        </ul>
                </div>
            </div>
            <div class="profile-bg-primary col-md-9">
                <div class="panel">
                    ...
                    <div class="user col-md-11">
                        ...
                        <img src="https://scontent.fbkk23-1.fna.fbcdn.net/v/t1.18169-9/28577217_2088760671359280_1763776994545250192_n.jpg?_nc_cat=103&ccb=1-6&_nc_sid=09cbfe&_nc_ohc=zqOruvMFpEwAX8txctA&_nc_ht=scontent.fbkk23-1.fna&oh=00_AT8ICl3Pw6Y0I8yFTSc-lNW5LKyB05ro3erY53X98PTMaw&oe=62A8B581" width="100" height="100" style="display: block; margin-left: auto; margin-right: auto;" class="rounded float-start">
                        </br>
