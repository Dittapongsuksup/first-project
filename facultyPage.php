            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="text-align:center;" id="exampleModalLabel">เพิ่มชื่อคณะ</h5>
                    ...
                    <div class="modal-body">
                        <form action="insert.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" required class="form-control" name="facultyName">
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" name="addFac" class="btn btn-success" onclick="return confirm('Are you sure you want to insert data!!');">Save</button>
                            </div>
                        </form>
                    </div>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="editFac.php?facultyId=<?= $faculty['facultyId']; ?>" class="btn btn-warning">Edit</a>
                                    <!--<a href="edit.php?delete=<?= $faculty['facultyId']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete!!');">Delete</a>-->
