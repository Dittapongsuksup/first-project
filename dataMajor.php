      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          if (isset($_GET['majorId'])) {
            ...
            $sql = $conn->query("SELECT students.*, major.majorName
                                    FROM students 
                                    INNER JOIN major ON students.majorId=major.majorId
                                    WHERE students.majorId=$majorId
          ...
          ?>
              <tr>
                ...
                <td><?= $majors['firstName']; ?></td>
                <td><?= $majors['lastName']; ?></td>
                <td><?= $majors['study']; ?></td>
                <td><?= $majors['class']; ?></td>
                <td><?= $majors['position']; ?></td>
              </tr>
          <?php }
          } ?>
        </tbody>
